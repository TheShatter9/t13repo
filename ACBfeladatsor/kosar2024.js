...
var acbAdatok = ObjektumFeltolto(eredmenyek);
...
function RealMadridKiir(meccsekSzama) {
...
function dontetlen(vizsgaltTomb) {
    var visszajelzoUzenet = "";
    var dontetlen = 0;
    var hazai = 0;
    var idegen = 0;
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function barcelona(vizsgaltTomb) {
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function barcelonaKiir(eredmeny) {
...
function novemberiMeccsek(vizsgaltTomb) {
    var meccsek = [];
    var datum = "2004-11-21";
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function novemberiMeccsekKiir(kiirandoErtek) {
...
function legtobbStadion(vizsgaltTomb) {
    var stadionok = [];
    for (var i = 0; i < vizsgaltTomb.length; i++) {
